...
import se.umu.cs.et14gsd.robot.*;
...
/*
import model.se.umu.cs.et14gsd.robot.Maze;
import model.se.umu.cs.et14gsd.robot.MemoryRobot;
import model.se.umu.cs.et14gsd.robot.Position;
import model.se.umu.cs.et14gsd.robot.RandomRobot;
import model.se.umu.cs.et14gsd.robot.RightHandRuleRobot;
import model.se.umu.cs.et14gsd.robot.Robot;
*/
...
public class MazeSimulation {
    ...
    protected JMenuBar createMenuBar() {
        ...
        file.add(open);
        file.add(quit);
        JMenu robot=new JMenu("se.umu.cs.et14gsd.robot.Robot");
        menuBar.add(file);
        menuBar.add(robot);
        return menuBar;
    }
    ...
    protected void loadMaze() {
        ...
        FileFilter filter = new FileNameExtensionFilter("se.umu.cs.et14gsd.robot.Maze file", "maze");
    ...
    public void runSimulation(Robot r) {
        ...
        if(r.hasReachedGoal())
            updateMessage("se.umu.cs.et14gsd.robot.Robot reached goal after "+i+" steps");
        else
            updateMessage("se.umu.cs.et14gsd.robot.Robot did not reach goal before reaching maximum number of steps");
    }
